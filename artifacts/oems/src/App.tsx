...
import LecturerGradebookPage from "@/pages/lecturer/gradebook";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/lecturer/gradebook">{() => <ProtectedRoute component={LecturerGradebookPage} allowedRoles={["lecturer"]} />}</Route>
